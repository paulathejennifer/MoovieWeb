...
export async function GET() {
  ...
  try {
    ...
    const baseUrl = process.env.BASE_URL || 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZmZlODgzNjg0MWFhMWNlNWQzYWQwNzIwMTc2MDA1NSIsIm5iZiI6MTc1NjIyNjI5My4zMjA5OTk5LCJzdWIiOiI2OGFkZTJmNWJkZDRmNDBjMjM2Y2Y2MzciLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.u2fWMdM5wpTrwfUQcdTN0lGZ84IQxnMbiADJk_sPi90';
